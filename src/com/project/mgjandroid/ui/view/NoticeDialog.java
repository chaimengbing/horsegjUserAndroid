...
public class NoticeDialog extends Dialog implements View.OnClickListener {
    ...
    public NoticeDialog(Context context, onBtnClickListener onBtnClickListener, String appTitle, String tips) {
        super(context);
    ...
    public NoticeDialog(Context context, onBtnClickListener onBtnClickListener, String appTitle, String tips, String sure) {
        super(context);
        this.onBtnClickListener = onBtnClickListener;
        this.context = context;
        this.appTitle = appTitle;
    ...
    public NoticeDialog(Context context, onBtnClickListener onBtnClickListener, String appTitle, String tips, String sure, String sureColor) {
        super(context);
        this.onBtnClickListener = onBtnClickListener;
        this.context = context;
        this.appTitle = appTitle;
