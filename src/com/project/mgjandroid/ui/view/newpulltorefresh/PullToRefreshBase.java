 ...
 *******************************************************************************/
package com.project.mgjandroid.ui.view.newpulltorefresh;
...
import com.project.mgjandroid.ui.view.newpulltorefresh.internal.FlipLoadingLayout;
import com.project.mgjandroid.ui.view.newpulltorefresh.internal.HorseLoadingLayout;
import com.project.mgjandroid.ui.view.newpulltorefresh.internal.LoadingLayout;
import com.project.mgjandroid.ui.view.newpulltorefresh.internal.RotateLoadingLayout;
import com.project.mgjandroid.ui.view.newpulltorefresh.internal.Utils;
import com.project.mgjandroid.ui.view.newpulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void setLodeMore(boolean doScroll) {
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (mOnRefreshListener2 != null) {
            mOnRefreshListener2.onPullDownValue(this, value);
        }
            ...
            switch (this) {
                ...
                default:
                    ...
                    if (mode == Mode.PULL_FROM_START) {
                        return new HorseLoadingLayout(context, mode, scrollDirection, attrs);
                    } else {
    ...
    public static interface OnRefreshListener2<V extends View> {
        ...
        public void onPullDownValue(final PullToRefreshBase<V> refreshView, int value);
