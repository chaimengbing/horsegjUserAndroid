...
/**
 * Created by yuandi on 2016/7/28.
 */
public class CallPhoneDialog extends Dialog implements View.OnClickListener {
    ...
    public CallPhoneDialog(Context context, onBtnClickListener onBtnClickListener, String appTitle, String tips) {
        super(context);
    ...
    public CallPhoneDialog(Context context, onBtnClickListener onBtnClickListener, String appTitle, String tips, String sure, String cancel) {
        super(context);
        this.onBtnClickListener = onBtnClickListener;
        this.context = context;
        this.appTitle = appTitle;
    ...
    public CallPhoneDialog(Context context, onBtnClickListener onBtnClickListener, String appTitle, String tips, String sure, String cancel, String sureColor, String cancelColor) {
        super(context);
        this.onBtnClickListener = onBtnClickListener;
        this.context = context;
        this.appTitle = appTitle;
