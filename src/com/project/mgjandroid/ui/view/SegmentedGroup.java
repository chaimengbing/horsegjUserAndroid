...
/**
 * Created by yuandi on 2016/3/18.
 */
public class SegmentedGroup extends RadioGroup {
    ...
    public SegmentedGroup(Context context) {
        ...
        mTintColor = resources.getColor(R.color.title_bar_bg);
        mMarginDp = (int) getResources().getDimension(R.dimen.sp1);
        mCornerRadius = getResources().getDimension(R.dimen.sp5);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            mMarginDp = (int) typedArray.getDimension(
                    R.styleable.SegmentedGroup_border_width2,
                    getResources().getDimension(R.dimen.sp1));

            mCornerRadius = typedArray.getDimension(
                    R.styleable.SegmentedGroup_corner_radius,
                    getResources().getDimension(R.dimen.sp5));

            mTintColor = typedArray.getColor(
                    R.styleable.SegmentedGroup_tint_color,
                    getResources().getColor(R.color.title_bar_bg));
    ...
    private void updateBackground(View view) {
        ...
        ColorStateList colorStateList = new ColorStateList(new int[][]{
                ...
                {-android.R.attr.state_pressed, -android.R.attr.state_checked},
                {-android.R.attr.state_pressed, android.R.attr.state_checked}},
                new int[]{mTintColor, mCheckedTextColor, mTintColor, mCheckedTextColor});
