...
public class RatingBar extends LinearLayout {
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        starImageSize = mTypedArray.getDimension(R.styleable.RatingBar_mStarImageSize, 20);
        ...
        starCount = mTypedArray.getInteger(R.styleable.RatingBar_mStarCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_mStarEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_mStarFill);
