...
//        mBorderPaint.setDither(true);
        ...
        try {
            ...
            mBorderThickness = a.getDimensionPixelSize(R.styleable.CornerImageView_borderThickness, 0);

            mBorderColor = a.getColor(R.styleable.CornerImageView_borderColor, defaultColor);
...
//        Log.e("TAG", "onDraw");
        ...
        if (type == TYPE_ROUND) {
            ...
            if (mBorderThickness > 0) {
                canvas.drawCircle(mRadius, mRadius, mRadius - mBorderThickness, mBitmapPaint);
                canvas.drawCircle(mRadius, mRadius, mRadius - mBorderThickness / 2, mBorderPaint);
            } else {
...
//        }
    ...
    public void setmBorderThickness(int borderThickness) {
        if (borderThickness != mBorderThickness) {
