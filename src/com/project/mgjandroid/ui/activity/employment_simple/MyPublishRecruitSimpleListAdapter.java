...
public class MyPublishRecruitSimpleListAdapter extends BaseListAdapter<NewRecruitInformation> {
    private View.OnClickListener listener;

    public MyPublishRecruitSimpleListAdapter(int layoutId, Activity mActivity) {
