...
public class JobSearchSimpleFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {
    ...
    private SimplePositionListAdapter adapter;
    ...
    private void initView() {
        ...
        adapter = new SimplePositionListAdapter(R.layout.job_simple_item, mActivity, InformationType.NewPosition.getValue());
...
//        listView.setEmptyView(emptyView);
                    ...
                    if (CheckUtils.isNoEmptyList(mlist)) {
                        ...
                        if (isLoadMore) {
                            ...
                            if (mlistOrg != null) {
                                ...
                                for (NewPositionInformation information : mlistOrg) {
                            ...
                            for (NewPositionInformation information : mlist) {
                                information.setServiceTime(model.getServertime());
                            }
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.NewPosition.getValue());
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.NewPosition.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.NewPosition.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
