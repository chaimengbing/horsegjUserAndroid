...
public class WithdrawWayActivity extends BaseActivity {
    ...
    private LinearLayout drawCashLayout;
    @InjectView(R.id.withdraw_cash)
...
//                }
            ...
            case R.id.add_bank_card:
                Intent intent1 = new Intent(this, BankCardInfoActivity.class);
    ...
    private void addCardInContainer(BankCard bankCard, int position) {
        ...
        ImageUtils.loadBitmap(mActivity, bankCard.getBankLogo(), imgLogo, R.drawable.horsegj_default, "");
...
//            String bankAddress = intent.getStringExtra("bankAddress");
...
//            bankCard.setSubbranchBankName(bankAddress);
...
//        map.put("subbranchBankName", mSelectCard.getSubbranchBankName());
        map.put("type", "bank");
