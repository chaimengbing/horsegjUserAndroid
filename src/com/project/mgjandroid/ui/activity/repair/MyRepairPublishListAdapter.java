 ...
 */
public class MyRepairPublishListAdapter extends BaseListAdapter<RepairInformation> {

    private View.OnClickListener listener;


    public MyRepairPublishListAdapter(int layoutId, Activity mActivity) {
    ...
    @Override
    protected void getRealView(ViewHolder holder, RepairInformation bean, int position, View convertView, ViewGroup parent) {
//
