...
public class RepairFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {
    ...
    private void initView() {
        ...
        adapter = new RepairListAdapter(R.layout.item_repair_list_view, mActivity);
...
//        listView.setEmptyView(emptyView);
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Repair.getValue());
    ...
    private void showTag(List<PositionCategoryBean> list) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i == 4) {
                ...
                repairLayout.addView(view);
            }
            repairLayout.addView(textView);
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Repair.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Repair.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
