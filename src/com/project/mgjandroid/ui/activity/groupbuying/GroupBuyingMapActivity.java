...
public class GroupBuyingMapActivity extends BaseActivity {
    ...
    public static void toGroupBuyingMapActivity(Context context, String name, String address, double latitude, double longitude) {
        Intent intent = new Intent(context, GroupBuyingMapActivity.class);
