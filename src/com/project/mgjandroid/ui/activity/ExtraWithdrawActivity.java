...
public class ExtraWithdrawActivity extends BaseActivity {
    ...
    @InjectView(R.id.withdraw_icon)
    private ImageView imgIcon;
    @InjectView(R.id.withdraw_tip1)
    private TextView tvTip;
    @InjectView(R.id.withdraw_tip2)
    private TextView tvMoney;
    @InjectView(R.id.withdraw_tip3)
        ...
        if (intent != null && intent.hasExtra("state")) {
            ...
            switch (mState) {
                case WITHDRAW_SUCCESS:
                    ...
                    String mgjPhone = PreferenceUtils.getStringPreference("mgjPhone", getString(R.string.sale_phone), this);
                    tvPhone.setText(getString(R.string.extra_two_day) + mgjPhone);
                    break;
                case WITHDRAW_FAIL:
