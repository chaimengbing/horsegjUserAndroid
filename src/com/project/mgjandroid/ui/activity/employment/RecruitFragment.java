...
public class RecruitFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {
    ...
    private void initView() {
        ...
        adapter = new RecruitListAdapter(R.layout.item_new_recruit, mActivity, InformationType.Recruit.getValue());
...
//        listView.setEmptyView(emptyView);
                    ...
                    if (CheckUtils.isNoEmptyList(mlist)) {
                        ...
                        if (isLoadMore) {
                            ...
                            if (mlistOrg != null) {
                                ...
                                for (RecruitInformation information : mlistOrg) {
                            ...
                            for (RecruitInformation information : mlist) {
                                information.setServiceTime(model.getServertime());
                            }
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Recruit.getValue());
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Recruit.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Recruit.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
