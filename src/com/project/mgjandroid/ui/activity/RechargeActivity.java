    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.recharge_100:
                ...
                tv2.setBackgroundColor(getResources().getColor(R.color.title_bar_bg));
            ...
            case R.id.recharge_200:
                ...
                tv3.setBackgroundColor(getResources().getColor(R.color.title_bar_bg));
            ...
            case R.id.recharge_300:
                ...
                tv4.setBackgroundColor(getResources().getColor(R.color.title_bar_bg));
...
//        rechargeNumberPopupwindow.showAsDropDown(rlRechargeMoneySelector);
    ...
    public void resetPopup() {
        ...
        tv3.setTextColor(getResources().getColor(R.color.color_3));
        tv4.setTextColor(getResources().getColor(R.color.color_3));
        tv5.setTextColor(getResources().getColor(R.color.color_3));
    }
