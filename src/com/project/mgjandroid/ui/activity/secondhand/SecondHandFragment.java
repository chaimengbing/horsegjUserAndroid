...
import com.project.mgjandroid.ui.activity.education.EducationListAdapter;
...
public class SecondHandFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {

    public final static String CATEGORY_ID = "category_id";
    public final static String CATEGORY_NAME = "category_name";

    @InjectView(R.id.secondhand_layout)
    private LinearLayout secondHandLayout;
    @InjectView(R.id.list_view)
    private PullToRefreshListView listView;

    private SecondHandMarketListAdapter adapter;
    ...
    private void initView() {
        ...
        adapter = new SecondHandMarketListAdapter(R.layout.item_second_hand_market_list_view, mActivity);
...
//        listView.setEmptyView(emptyView);
        ...
        operater.doRequest(Constants.URL_FIND_INFORMATION_LIST, map, new VolleyOperater.ResponseListener() {
            ...
            public void onRsp(boolean isSucceed, Object obj) {
                ...
                if (isSucceed && obj != null) {
                    ...
                    SecondHandModel model = (SecondHandModel) obj;
                    ...
                    if (CheckUtils.isNoEmptyList(mlist)) {
                        ...
                        if (isLoadMore) {
                            ...
                            if (mlistOrg != null) {
                                ...
                                for (SecondhandInformation information : mlistOrg) {
                            ...
                            for (SecondhandInformation information : mlist) {
                                information.setServiceTime(model.getServertime());
                            }
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Secondhand.getValue());
    ...
    private void showTag(List<PositionCategoryBean> list) {
        if (CheckUtils.isEmptyList(list)) {
            secondHandLayout.setVisibility(View.GONE);
            return;
        }
        secondHandLayout.setVisibility(View.VISIBLE);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i == 4) {
                ...
                secondHandLayout.addView(view);
            }
            secondHandLayout.addView(textView);
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Secondhand.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Secondhand.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
