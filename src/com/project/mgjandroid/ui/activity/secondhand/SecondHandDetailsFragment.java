...
public class SecondHandDetailsFragment extends BaseFragment implements View.OnClickListener {
    ...
    public SecondHandDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_second_hand_detail, container, false);
    ...
    private void showData() {
        ...
        tvPrice.setText(StringUtils.getPrice(mActivity, StringUtils.money2Str(information.getAmt(), "元")));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.second_hand_detail_contact:
                if (information != null)
                    findInformationFreeStandardList(information.getUserId(), information.getId(), information.getAgentId(), InformationType.Secondhand.getValue(), information.getCategoryId(), 3);
                break;
        }
    }
