...
public class CameraActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    @InjectView(R.id.act_camera_sv)
    private SurfaceView surfaceView;
    @InjectView(R.id.act_camera_recycler_view)
    private RecyclerView recyclerView;
    @InjectView(R.id.act_camera_tv_cancel)
    private TextView tvCancel;
    @InjectView(R.id.act_camera_iv_take_photo)
    private ImageView ivTakePhoto;
    @InjectView(R.id.act_camera_tv_confirm)
    private TextView tvConfirm;
    @InjectView(R.id.tv_photo_count)
    private TextView tvPhotoCount;
    @InjectView(R.id.flash_layout)
    private LinearLayout flashLayout;
    @InjectView(R.id.iv_flash_mode)
    private ImageView ivFlashMode;
    @InjectView(R.id.tv_flash_mode)
    ...
    private void confirmPhoto() {
        ...
        if (PublishUsedGoodsInfoActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                ...
                || PublishRecruitmentActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                || PublishResumeActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                || PublishFengShuiInformationActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                || PublishHealthConsultationInformationActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                || PublishLegalConsultingActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                || PublishRecyclingInformationActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
                || PublishFamilyEducationInfoActivity.class.getName().equals(ChoosePhotoModel.getInstance().getFrom())
