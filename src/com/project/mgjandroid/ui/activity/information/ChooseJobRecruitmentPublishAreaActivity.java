...
public class ChooseJobRecruitmentPublishAreaActivity extends BaseActivity {
    ...
    public static void toChoosePublishArea(Activity context, int requestCode) {
        Intent intent = new Intent(context, ChooseJobRecruitmentPublishAreaActivity.class);
