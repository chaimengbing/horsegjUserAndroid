...
public class ReportActivity extends BaseActivity {
    ...
    @InjectView(R.id.report_act_tv_1)
    private TextView tvReport1;
    @InjectView(R.id.report_act_tv_2)
    private TextView tvReport2;
    @InjectView(R.id.report_act_tv_3)
    private TextView tvReport3;
    @InjectView(R.id.report_act_tv_4)
    private TextView tvReport4;
    @InjectView(R.id.report_act_tv_5)
    private TextView tvReport5;
    @InjectView(R.id.report_act_tv_6)
    private TextView tvReport6;
    ...
    public static void toReport(Context context, long informationId, int informationType) {
    ...
    private void report() {
        ...
        operater.doRequest(Constants.URL_REPORT_INFORMATION, map, new VolleyOperater.ResponseListener() {
            @Override
