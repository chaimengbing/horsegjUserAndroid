...
import com.project.mgjandroid.ui.activity.geomancy.FengShuiListAdapter;
...
public class LegalAdviceFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {

    public final static String CATEGORY_ID = "category_id";
    public final static String CATEGORY_NAME = "category_name";

    @InjectView(R.id.law_layout)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_legal_advice, container, false);
    ...
    private void initView() {
        ...
        adapter = new LawListAdapter(R.layout.item_law, mActivity);
...
//        listView.setEmptyView(emptyView);
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Law.getValue());
    ...
    private void showTag(List<PositionCategoryBean> list) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i == 4) {
                ...
                lawLayout.addView(view);
            }
            lawLayout.addView(textView);
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Law.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Law.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
