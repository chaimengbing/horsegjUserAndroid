...
@Router("secondHandMarket")
public class ChooseSecondHandActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_second_hand);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_type_1:
                ...
                Intent intent1 = new Intent(mActivity, SecondHandMarketActivity.class);
                startActivity(intent1);
                break;
            case R.id.iv_type_2:
                ChooseCityModel.getInstance().setSecondHandType(1);
                Intent intent2 = new Intent(mActivity, SecondHandMarketActivity.class);
