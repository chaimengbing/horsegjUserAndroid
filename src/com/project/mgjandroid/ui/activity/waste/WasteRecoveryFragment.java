...
public class WasteRecoveryFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {

    public final static String CATEGORY_ID = "category_id";
    public final static String CATEGORY_NAME = "category_name";

    @InjectView(R.id.waste_layout)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_waste_recovery, container, false);
    ...
    private void initView() {
        ...
        adapter = new WasteListAdapter(R.layout.item_waste, mActivity);
...
//        listView.setEmptyView(emptyView);
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.WasteRecovery.getValue());
    ...
    private void showTag(List<PositionCategoryBean> list) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i == 4) {
                ...
                wasteLayout.addView(view);
            }
            wasteLayout.addView(textView);
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.WasteRecovery.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.WasteRecovery.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
