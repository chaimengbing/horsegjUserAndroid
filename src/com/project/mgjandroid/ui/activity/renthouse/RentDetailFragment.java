...
public class RentDetailFragment extends BaseFragment implements View.OnClickListener, ViewPager.OnPageChangeListener {
...
//        }
    ...
    private void showData() {
        ...
        tvAreaTip.setVisibility(View.GONE);
        tvArea.setVisibility(View.GONE);
        tvPrice.setText(StringUtils.getPrice(mActivity, information.getLeasePrice() + "元/月"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rent_house_detail_contact:
                if (information != null)
                    findInformationFreeStandardList(information.getUserId(), information.getId(), information.getAgentId(), InformationType.Rent.getValue(), information.getCategoryId(), 3);
                break;
        }
    }
