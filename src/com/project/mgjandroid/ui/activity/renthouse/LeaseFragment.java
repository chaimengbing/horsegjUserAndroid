...
public class LeaseFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {
    ...
    private LeaseRentListAdapter adapter;
    ...
    private void initView() {
        ...
        adapter = new LeaseRentListAdapter(R.layout.item_rent_house_list_view, mActivity);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position >= listView.getRefreshableView().getHeaderViewsCount()) {
                    ...
                    InformationDetailActivity.toInformationDetail(mActivity, information.getId(), InformationType.Lease.getValue());
                }
            }
        });
...
//        listView.setEmptyView(emptyView);
                    ...
                    if (CheckUtils.isNoEmptyList(mlist)) {
                        ...
                        if (isLoadMore) {
                            ...
                            if (mlistOrg != null) {
                                ...
                                for (HouseLeaseInformation information : mlistOrg) {
                            ...
                            for (HouseLeaseInformation information : mlist) {
                                information.setServiceTime(model.getServertime());
                            }
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Lease.getValue());
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Lease.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Lease.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
