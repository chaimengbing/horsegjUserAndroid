...
import com.project.mgjandroid.ui.activity.employment.PositionListAdapter;
...
public class EducationFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_education_consultation, container, false);
    ...
    private void initView() {
        ...
        adapter = new EducationListAdapter(R.layout.item_education_list_view, mActivity);
...
//        listView.setEmptyView(emptyView);
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Education.getValue());
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Education.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Education.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
