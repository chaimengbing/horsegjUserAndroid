...
public class FamilyEducationDetailsFragment extends BaseFragment implements View.OnClickListener {
    ...
    public FamilyEducationDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_family_education_detail, container, false);
    ...
    private void showData() {
        ...
        tvType.setText(information.getEducationTeacherTypeName());
        tvArea.setText(information.getEducationTutorshipStageName());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.education_detail_detail_contact:
                if (information != null)
                    findInformationFreeStandardList(information.getUserId(), information.getId(), information.getAgentId(), InformationType.FamilyEducation.getValue(), information.getCategoryId(), 3);
                break;
        }
    }
