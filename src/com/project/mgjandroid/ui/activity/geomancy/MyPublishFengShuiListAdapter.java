...
public class MyPublishFengShuiListAdapter extends BaseListAdapter<InformationFengShui> {

    private View.OnClickListener listener;

    public MyPublishFengShuiListAdapter(int layoutId, Activity mActivity) {
    ...
    protected void getRealView(ViewHolder holder, InformationFengShui bean, int position, View convertView, ViewGroup parent) {
        ...
        ImageView status = holder.getView(R.id.my_publish_fengshui_status);
        ...
        holder.setText(R.id.fengshui_practiceTime, bean.getAge() + "岁");
        holder.setText(R.id.tv_fengshui_province, bean.getWhereProvinceName());
        holder.setText(R.id.fengshui_be_good_at, "擅长：" + bean.getGoodField());
        String imgs = bean.getImgs();
        CornerImageView avatar = holder.getView(R.id.new_fengshui_user_avatar);
