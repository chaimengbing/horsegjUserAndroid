...
public class FengShuiMasterFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, View.OnClickListener {

    public final static String CATEGORY_ID = "category_id";
    public final static String CATEGORY_NAME = "category_name";

    @InjectView(R.id.fengshui_layout)
    private LinearLayout fengshuiLayout;
    ...
    private int start = 0;
    private FengShuiListAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_fengshui_master, container, false);
    ...
    private void initView() {
        ...
        adapter = new FengShuiListAdapter(R.layout.item_fengshui, mActivity);
...
//        listView.setEmptyView(emptyView);
    ...
    public void getTagDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("informationTypeId", InformationType.Divination.getValue());
    ...
    private void showTag(List<PositionCategoryBean> list) {
        if (CheckUtils.isEmptyList(list)) {
            fengshuiLayout.setVisibility(View.GONE);
            return;
        }
        fengshuiLayout.setVisibility(View.VISIBLE);
        fengshuiLayout.removeAllViews();
        for (int i = 0; i < 5; i++) {
            ...
            if (i == 4) {
                ...
                fengshuiLayout.addView(view);
            }
            fengshuiLayout.addView(textView);
            if (i < 4 && list.size() > i) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationActivity.toInformationList(mActivity, ((Long) textView.getTag()), textView.getText().toString(), InformationType.Divination.getValue());
                    }
                });
                if (i < 3) {
                    View view = new View(mActivity);
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        InformationCategoryChooseActivity.toChooseInformationCategory(mActivity, InformationType.Divination.getValue(), InformationCategoryChooseActivity.FROM_INFORMATION_LIST_PAGE);
                    }
                });
            }
        }
