...
public class HomeMakingDetailsFragment extends BaseFragment implements View.OnClickListener {
    @InjectView(R.id.my_banner)
    private MyBanner myBanner;
    @InjectView(R.id.tv_photo_count)
    private TextView tvPhotoCount;
    @InjectView(R.id.home_making_detail_name)
    private TextView tvName;
    @InjectView(R.id.home_making_detail_tag)
    private TextView tvTag;
    @InjectView(R.id.home_making_detail_price)
    private RatingBar rbEvaluate;
    @InjectView(R.id.home_making_detail_score_text)
    private TextView tvEvaluate;
    @InjectView(R.id.home_making_detail_jubao)
    private TextView tvReport;
    @InjectView(R.id.home_making_detail_detail_content)
    private TextView tvContent;
    @InjectView(R.id.home_making_detail_detail_contact)
    private TextView tvContact;
    @InjectView(R.id.home_making_type)
    private TextView tvType;
    @InjectView(R.id.home_making_detail_location)
    private TextView tvLocation;
    @InjectView(R.id.home_making_detail_area_tip)
    private TextView tvAreaTip;
    @InjectView(R.id.home_making_detail_area)
    private TextView tvArea;
    @InjectView(R.id.home_making_detail_score)
    ...
    @InjectView(R.id.home_making_detail_feature)
    private TextView tvFeature;

    private MLoadingDialog mLoadingDialog;
    private HomemakingInformation information;

    public HomeMakingDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_home_making_detail, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.home_making_detail_detail_contact:
                if (information != null)
                    findInformationFreeStandardList(information.getUserId(), information.getId(), information.getAgentId(), InformationType.Homemaking.getValue(), information.getCategoryId(), 3);
                break;
        }
    }
