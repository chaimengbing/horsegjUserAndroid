...
public class EvaluateImageRecyclerAdapter extends RecyclerView.Adapter {
    ...
    public EvaluateImageRecyclerAdapter(Context context, boolean isNeedAdd) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 2) {
            return new AddViewHolder(inflater.inflate(R.layout.recycler_picture_add_view, parent, false));
        } else {
