...
public class AddressManagerListAdapter extends BaseAdapter {
    ...
    public void setMerchantOrAgentId(long merchantId, int agentId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvAddress.setText(userAddress.getHouseNumber() != null ? (userAddress.getAddress() + " " + userAddress.getHouseNumber()) : userAddress.getAddress());
        if (canModify) {
