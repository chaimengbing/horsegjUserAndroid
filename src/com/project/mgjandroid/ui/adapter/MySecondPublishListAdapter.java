 ...
 */
public class MySecondPublishListAdapter extends BaseListAdapter<SecondhandInformation> {

    private View.OnClickListener listener;

    public MySecondPublishListAdapter(int layoutId, Activity mActivity) {
    ...
    protected void getRealView(ViewHolder holder, SecondhandInformation bean, int position, View convertView, ViewGroup parent) {
        ...
        TextView tvPrice = holder.getView(R.id.tv_no_score);
        ...
        if (bean.getType() == 1) {
            tvNoScore.setTextColor(Color.parseColor("#fb4b18"));
            tvPrice.setText(bean.getAmt().toString() + "元");
        } else if (bean.getType() == 2) {
            tvNoScore.setTextColor(Color.parseColor("#fb4b18"));
            tvPrice.setText(bean.getMinAmt().toString() + "元" + "--" + bean.getMaxAmt().toString() + "元");
        }
