 ...
 */
public class MyEducationPublishListAdapter extends BaseListAdapter<EducationInformation> {

    private View.OnClickListener listener;

    public MyEducationPublishListAdapter(int layoutId, Activity mActivity) {
    ...
    protected void getRealView(ViewHolder holder, EducationInformation bean, int position, View convertView, ViewGroup parent) {
        ...
        RatingBar rbScore = holder.getView(R.id.group_detail_admin_score);
