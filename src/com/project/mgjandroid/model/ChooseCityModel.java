...
import com.project.mgjandroid.model.InformationAreaModel.ValueBean;
...
public class ChooseCityModel {
    ...
    public void initData(Context context) {
        String data = PreferenceUtils.getInformationArea(context);
        if (CheckUtils.isNoEmptyStr(data)) {
            ValueBean valueBean = JSON.parseObject(data, ValueBean.class);
            setCityName(valueBean.getName());
            setCityCode(valueBean.getBaiduCityCode());
            setProvinceId(valueBean.getProvince());
            setCityId(valueBean.getCity());
            setDistrictId(valueBean.getDistrict());
        }
    }
